...
# Ultralytics YOLO 🚀, AGPL-3.0 license
"""Convolution modules."""
from ultralytics.nn.modules.swintransformer import DropPath
import sys
...
from ultralytics.ops_dcnv3.modules.dcnv3 import DCNv3_pytorch
from ultralytics.nn.modules.kan import KANLinear

__all__ = ('Conv', 'Conv2', 'LightConv', 'PConv','DWConv', 'DWConvTranspose2d', 'ConvTranspose', 'Focus', 'GhostConv',
           'ChannelAttention', 'SpatialAttention', 'CBAM', 'Concat', 'RepConv', 'SwinTransformer','DCNV2','DCNv3_PyTorch'
           ,'space_to_depth')
...
class WindowAttention(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        #self.qkv = KAN(dim, dim * 3, bias=qkv_bias)
        self.attn_drop = nn.Dropout(attn_drop)
        #self.proj = KAN(dim, dim)
