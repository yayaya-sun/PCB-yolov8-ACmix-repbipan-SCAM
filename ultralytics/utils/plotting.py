...
class Colors:
    ...
    def __init__(self):
        ...
        hexs = ('00cc00', 'FF3838', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
        ...
        # mapped_label = self.label_mapping.get(label)
        # label = mapped_label
...
def plot_images(images,
    ...
    annotator = Annotator(mosaic, line_width=round(fs / 10), font_size=8, pil=True, example=names)
    for i in range(i + 1):
        x, y = int(w * (i // ns)), int(h * (i % ns))  # block origin
